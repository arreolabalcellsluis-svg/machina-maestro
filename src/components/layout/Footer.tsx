      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="flex flex-col justify-start">
            <img src={logoUrl} alt="REDBUCK Logo" className="h-20 w-[75%] object-contain mb-2" />
            ...
            <div className="flex gap-4">
              <a href="https://www.facebook.com/profile.php?id=61574051147456" target="_blank" rel="noopener noreferrer" className="h-10 w-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-primary transition-colors">
              ...
              <a href="https://www.youtube.com/@redbuckequipment837" target="_blank" rel="noopener noreferrer" className="h-10 w-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-primary transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <a href="tel:3313872649" className="flex items-center gap-3 text-gray-400 hover:text-primary transition-colors">
